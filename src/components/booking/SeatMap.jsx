    ...
    const getSelectedSeatInfo = () => {
        return selectedSeats
            .map((seatId) => {
                ...
                return seat
                    ? { id: seatId, price: seat.price, class: seat.class }
                    : null;
            })
            .filter(Boolean);
    };
            ...
            <CardContent>
                ...
                <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="text-blue-800 font-medium">
                        Select {maxSeats} seat{maxSeats > 1 ? "s" : ""} for your
                        passengers
                    </p>
                ...
                <div className="bg-slate-50/50 p-6 rounded-lg border border-slate-200">
                    <div className="text-center text-slate-500 mb-4 text-sm font-medium">
                        Front of Aircraft
                    </div>
                            ...
                            {getSelectedSeatInfo().map((seat, index) => (
                                ...
                                >
                                    <span className="text-emerald-700">
                                        Passenger {index + 1}: Seat {seat?.id} (
                                        {seat?.class})
                                    </span>
